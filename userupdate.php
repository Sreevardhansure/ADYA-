...
if(isset($_POST['submit'])){
    ...
    $sql = "update login set id=$id,username='$username',password='$password',mobile='$mobile',stuemail='$stuemail'
    where id=$id";
    $result=mysqli_query($con,$sql);
    if($result)
    { ?>
...
<body>
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="hidden" id="id" name="id" placeholder="Enter Your ID" required value=<?php
                echo $id;
                ?>>
    ...
    <br><br>
        <a href="userhomepage.php" class="wiggle-btn">
