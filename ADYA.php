...
<head>
    ...
    <link rel="stylesheet" href="ADYA mobile.css">
    ...
    <div class="flip-card">
        <div class="flip-card-inner">
          ...
          <div class="flip-card-back">
            <img src="profile.png" alt="Back Image">
          </div>
        </div>
      </div>
      
        <a href="ADYA.php" class="logo">ADYA<pre><p>Study Circle</p> </pre></a>
       <nav class="navbar">
            <a href="ADYA.php" style="--i:1"class="active">Home</a>
      ...
      <div class="sub-menu-wrap" id="subMenu">
        <div class="sub-menu">
          ...
          <a href="aboutus trail.html" class="sub-menu-link">
              <img src="book.png" alt="error"><p> About us</p><span>﹥</span></a>
            ...
            <div class="monkeylogin">
              ...
              <footer class="foot">
                <h4>Don't have account</h4>
                  <a style="color:orange; font-weight: bold;right: 50%;left: 50%;" href="registration.html">register now</a></footer>
            </div>
            ...
            <div class="contentBox">
              ...
              <div class="content">
               <div> <h3>Special Offer</h3>
                ...
                <h5>Adya Study Circle Best offers ever.</h5>
